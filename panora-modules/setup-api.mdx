...
local panoraInstance = PanoraModule.init("WORKSPACEID", {
    ...
    Activity = {
        ...
        Webhook = true, -- Set to false to disable the webhook
    },
})
```
...
<Steps activeStep={0}>
  <Step title="Install Panora Module">
    <p>In your Roblox game, add the Panora API Script to your project, naming it "PanoraAPI". Use the following code to require the module:</p>
